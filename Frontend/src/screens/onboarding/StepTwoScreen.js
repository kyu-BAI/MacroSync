...
export default function StepTwoScreen({ onNext, currentWeight, height }) {
  ...
  const handleContinue = async () => {
    ...
    if (!goalWeight || !targetDate) {
      Alert.alert(
        "Missing Fields",
        "Please specify your goal weight and a target date before continuing.",
      );
      return;
    }
              ...
              {goals.map((goal) => {
                ...
                return (
                  <View
                    ...
                    style={
                      isActive
                        ? styles.goalCardActiveWrap
                        : styles.goalCardInactiveWrap
                    }
                  >
                    <TouchableOpacity
                      activeOpacity={0.9}
                      ...
                      style={[
                        ...
                        isActive && styles.goalCardInnerActive,
                      ]}
                    >
                      <Text
                        style={[
              ...
              <View
                style={
                  isPressed || isLoading
                    ...
                    : styles.btnShadowWhite
                }
              >
                <View
                  style={isPressed || isLoading ? null : styles.btnShadowDark}
                >
                  <TouchableOpacity
                    activeOpacity={1}
                    disabled={isLoading}
                    ...
                    style={[
                      ...
                      isPressed || isLoading
                        ? styles.buttonInnerPressed
                        : styles.buttonInnerUnpressed,
                    ]}
                  >
                    {isLoading ? (
