...
export default function ResetPasswordScreen({ onResetSuccess }) {
      ...
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={styles.container}>
        <ScrollView contentContainerStyle={styles.scrollContainer} keyboardShouldPersistTaps="handled">
          ...
          <View style={styles.headerSection}>
            ...
            <Text style={styles.brandSubtitle}>Please choose a new strong security credential string for MacroSync.</Text>
          </View>
          ...
          <View style={[styles.neumorphicOuter, styles.formSection]}>
            ...
            >
              <Text style={[styles.buttonText, isPressed && styles.buttonTextPressed]}>Update Password</Text>
            </TouchableOpacity>
          </View>
...
const styles = StyleSheet.create({
  ...
  brandSubtitle: { fontSize: 15, color: '#718096', marginTop: 8, textAlign: 'center' },
