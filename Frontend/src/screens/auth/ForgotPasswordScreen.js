...
export default function ForgotPasswordScreen({ onNavigateBack, onCodeSent }) {
      ...
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={styles.container}>
        <ScrollView contentContainerStyle={styles.scrollContainer} keyboardShouldPersistTaps="handled">
          ...
          <View style={styles.headerSection}>
            ...
            <Text style={styles.brandSubtitle}>Enter your registered email address below.</Text>
          </View>
          ...
          <View style={[styles.neumorphicOuter, styles.formSection]}>
            ...
            >
              <Text style={[styles.buttonText, isPressed && styles.buttonTextPressed]}>Send Reset Code</Text>
            </TouchableOpacity>
