...
export default function DietRecipesScreen({
  ...
  const { language, translateMealTitle, translateMealCategory } = useLanguage();
    ...
    async (meal) => {
      ...
      try {
        ...
        showAlert(
          ...
          "Failed to retrieve recipe from AI. Please check your network connection.",
        );
      } finally {
      ...
      const timer = setTimeout(() => {
        fetch(`${API_URL}/meals/recommend/${userId}`)
          ...
          .catch(
            (err) =>
              __DEV__ &&
              console.warn("Error loading AI meals in DietRecipesScreen:", err),
          );
      }, 150);
    ...
    const loadUserAllergies = async () => {
      try {
        ...
        if (onboardingData) {
          ...
          if (
            Array.isArray(parsedOnb.allergies) &&
            parsedOnb.allergies.length > 0
          ) {
  ...
  const CITY_PROFILES = {
    "Cebu City": {
      ...
      palengkeItems:
        "Pasil Fresh Fish, Singkamas, Pork Belly, Kangkong, Calamansi",
      lat: 10.3157,
      lng: 123.8854,
      famousDishes: [
        {
          name: "Pasil Tuslob Buwa",
          emoji: "🧠",
          desc: "Frothy pig brain & liver stew cooked with onions & chili, dipped with puso (hanging rice).",
        },
        {
          name: "Cebuano Ngohiong",
          emoji: "🌯",
          desc: "Crispy five-spice fried lumpia stuffed with ubod/singkamas, served with garlic brown dip.",
        },
        {
          name: "Lechon sa Sugbo",
          emoji: "🐖",
          desc: "World-famous herb & lemongrass stuffed charcoal roasted pork with super crispy skin.",
        },
        {
          name: "Ginabot (Chicharon Bulaklak)",
          emoji: "🍳",
          desc: "Deep-fried pork mesentery, a legendary Cebuano night market street food staple.",
        },
      ],
    },
    "Lapu-Lapu City": {
      ...
      famousDishes: [
        {
          name: "Sutukil Seafood Trilogy",
          emoji: "🐟",
          desc: "Iconic 3-way seafood meal: Sugba (Grilled), Tula (Fish Soup), and Kinilaw (Raw Cured).",
        },
        {
          name: "Linarang na Bakasi sa Cordova",
          emoji: "🐍",
          desc: "Cordova moray eel stew cooked with kamias souring broth, black beans, and chili.",
        },
        {
          name: "Presko nga Saang sa Mactan",
          emoji: "🐚",
          desc: "Steamed local sea snails dipped in spicy native tuba vinegar and ginger.",
        },
      ],
    },
    "Mandaue City": {
      ...
      famousDishes: [
        {
          name: "Bibingka sa Mandaue",
          emoji: "🫓",
          desc: "Heritage baked rice cake made with tuba yeast, coconut milk, and banana leaves.",
        },
        {
          name: "Tagaktak sa Mandaue",
          emoji: "🕸️",
          desc: "Crispy net-like sweet rice flour treat fried to golden perfection.",
        },
        {
          name: "Utan Bisaya sa Mandaue",
          emoji: "🥣",
          desc: "Clear vegetable soup seasoned with fried tuyô/danggit and fresh local greens.",
        },
      ],
    },
    "Talisay City": {
      ...
      palengkeItems:
        "Pork Belly, Inun-unan Fish, Kangkong, Cucumber, Native Tomatoes",
      lat: 10.2447,
      lng: 123.8494,
      famousDishes: [
        {
          name: "Inasal nga Lechon sa Talisay",
          emoji: "🍖",
          desc: "Home of the original Cebu Lechon Festival, famed for rich savory herb-infused pork.",
        },
        {
          name: "Inun-unan nga Bisaya",
          emoji: "🐟",
          desc: "Fish braised in native tuba vinegar, garlic, ginger, finger chilies, and eggplant.",
        },
      ],
    },
    "Carcar City": {
      ...
      famousDishes: [
        {
          name: "Chicharon sa Carcar",
          emoji: "🥓",
          desc: "Famous crunchy pork cracklings crafted with thick savory meat & fat layers.",
        },
        {
          name: "Ampaw sa Carcar",
          emoji: "🍿",
          desc: "Puffed rice crispy square treats bound with sweet native syrup and peanuts.",
        },
        {
          name: "Humba sa Carcar",
          emoji: "🍲",
          desc: "Tender pork belly braised with fermented black beans, banana blossoms, and tuba sugar.",
        },
      ],
    },
    Argao: {
      ...
      palengkeItems:
        "Native Sikwate (Cacao), Torta, Native Pork, Alugbati, Eggplant",
      lat: 9.8808,
      lng: 123.5975,
      famousDishes: [
        {
          name: "Torta sa Argao",
          emoji: "🥮",
          desc: "Heritage Spanish-era cake baked with tuba yeast, lard, egg yolks, and grated cheese.",
        },
        {
          name: "Batirol nga Sikwate sa Argao",
          emoji: "☕",
          desc: "Rich hot chocolate frothed with a batirol using 100% native cacao tablea.",
        },
        {
          name: "Chiu-Chiu nga Baboy sa Argao",
          emoji: "🍲",
          desc: "Traditional Argao braised pork belly stewed with spices and native herbs.",
        },
      ],
    },
    "Bogo City": {
      ...
      palengkeItems:
        "Tangigue, Sweet Corn, Native Tomatoes, Cucumber, Calamansi",
      lat: 11.0517,
      lng: 124.0055,
      famousDishes: [
        {
          name: "Pintos sa Bogo",
          emoji: "🌽",
          desc: "Famous sweet corn tamales mixed with coconut milk, steamed inside fresh corn husks.",
        },
        {
          name: "Kinilaw nga Tangigue sa Amihanan",
          emoji: "🥗",
          desc: "Fresh Spanish mackerel cured in native coconut vinegar, ginger, and chilies.",
        },
      ],
    },
    "San Remigio": {
      ...
      palengkeItems:
        "Bangus, Tilapia, Fresh Lato, Kangkong, Squash, Gabi Leaves",
      lat: 11.0772,
      lng: 123.9356,
      famousDishes: [
        {
          name: "Presko nga Salada nga Lato",
          emoji: "🌿",
          desc: "Crunchy grape seaweed tossed with native tomatoes, calamansi juice, and onions.",
        },
        {
          name: "Sinugbang Bangus sa Dahon sa Saging",
          emoji: "🐟",
          desc: "Charcoal-grilled milkfish stuffed with tomatoes and onions, wrapped in banana leaf.",
        },
      ],
    },
    Daanbantayan: {
      ...
      palengkeItems:
        "Bodboron, Tulingan, Purple Kamote, Eggplant, Native Ginger",
      lat: 11.2589,
      lng: 124.0153,
      famousDishes: [
        {
          name: "Inun-unan nga Bodboron",
          emoji: "🍲",
          desc: "Small ocean fish simmered gently in native vinegar, ginger, and green peppers.",
        },
        {
          name: "Linat-ang Tulingan sa Daanbantayan",
          emoji: "🐟",
          desc: "Rich tuna-like fish stewed with native ginger, dried kamias, and tomatoes.",
        },
      ],
    },
    "Bantayan Island": {
      ...
      palengkeItems:
        "Dried Danggit, Blue Crab, Shellfish, Calamansi, Young Coconut",
      lat: 11.1681,
      lng: 123.7222,
      famousDishes: [
        {
          name: "Buwad nga Danggit sa Bantayan",
          emoji: "🐟",
          desc: "World-renowned crispy rabbitfish dried under the island sun, dipped in vinegar.",
        },
        {
          name: "Nilung-ag nga Kasag sa Bantayan",
          emoji: "🦀",
          desc: "Freshly caught ocean blue swimmer crabs steamed with ginger and calamansi.",
        },
        {
          name: "Buwad nga Pusit",
          emoji: "🦑",
          desc: "Crispy sun-dried squid toasted over coals until golden and fragrant.",
        },
      ],
    },
    "Camotes Islands": {
      ...
      palengkeItems:
        "Cassava, Buko, Native Chicken, Fresh Ocean Fish, Kangkong",
      lat: 10.6558,
      lng: 124.3431,
      famousDishes: [
        {
          name: "Cassava Cake sa Camotes",
          emoji: "🥧",
          desc: "Traditional baked cassava root cake enriched with fresh coconut milk and sugar.",
        },
        {
          name: "Halang-Halang nga Manok sa Gata",
          emoji: "🌶️",
          desc: "Spicy chicken coconut milk soup infused with chili leaves, ginger, and lemongrass.",
        },
      ],
    },
    "Toledo City": {
      ...
      famousDishes: [
        {
          name: "Gisadong Ulang sa Toledo",
          emoji: "🦐",
          desc: "Large freshwater river prawns sautéed in garlic, butter, and native tomatoes.",
        },
        {
          name: "Sinugbang Tilapia sa Kamayan",
          emoji: "🐟",
          desc: "Fresh river tilapia grilled over charcoal, served with calamansi soy dip.",
        },
      ],
    },
    Balamban: {
      ...
      famousDishes: [
        {
          name: "Sinugbang Liempo sa Balamban",
          emoji: "🥓",
          desc: "Famous pork belly rolled and stuffed with secret herbs, scallions, and lemongrass.",
        },
        {
          name: "Tinolang Manok sa Balamban",
          emoji: "🍲",
          desc: "Free-range chicken stewed with green papaya, ginger, and fresh malunggay.",
        },
      ],
    },
    Moalboal: {
      ...
      famousDishes: [
        {
          name: "Sinugbang Tangigue Steak sa Moalboal",
          emoji: "🥩",
          desc: "Thick yellowfin tuna steak seared over high heat, drizzled with calamansi dip.",
        },
        {
          name: "Kinilaw nga Mackerel sa Baybayon",
          emoji: "🥗",
          desc: "Freshly caught mackerel cured in coconut vinegar, cucumber, and ginger.",
        },
      ],
    },
    Oslob: {
      ...
      famousDishes: [
        {
          name: "Sinigang nga Tangigue sa Oslob",
          emoji: "🍲",
          desc: "Sour fish soup made with fresh king mackerel, native tomatoes, and greens.",
        },
        {
          name: "Salada nga Dahon sa Kamote",
          emoji: "🌿",
          desc: "Blanched sweet potato leaves tossed with calamansi, onions, and native tomatoes.",
        },
      ],
    },
    "Danao City": {
      ...
      famousDishes: [
        {
          name: "Kalamay sa Danao",
          emoji: "🍯",
          desc: "Famous sticky sweet coconut & glutinous rice delicacy packaged in coconut shells.",
        },
        {
          name: "Inasal nga Bangus sa Danao",
          emoji: "🐟",
          desc: "Whole milkfish deboned and stuffed with savory meat, raisins, and spices.",
        },
      ],
    },
    Liloan: {
      ...
      famousDishes: [
        {
          name: "Rosquillos sa Titay (Liloan)",
          emoji: "🥨",
          desc: "The original ring-shaped crisp biscuit created in Liloan back in 1907.",
        },
        {
          name: "Masi sa Liloan",
          emoji: "🍡",
          desc: "Soft glutinous rice balls filled with a sweet molten peanut and brown sugar center.",
        },
      ],
    },
    Dalaguete: {
      ...
      famousDishes: [
        {
          name: "Gisadong Utan sa Mantalongon",
          emoji: "🥦",
          desc: "Crispy stir-fried Sayote, Broccoli, Carrots & Cabbage from the Vegetable Basket of Cebu.",
        },
        {
          name: "Linat-ang Baboy ug Sayote",
          emoji: "🍲",
          desc: "Hearty highland pork soup simmered with freshly harvested sayote and ginger.",
        },
      ],
    },
    Barili: {
      ...
      palengkeItems:
        "Carabao Milk, Pastillas, Native Eggs, Native Chicken, Squash",
      lat: 10.1133,
      lng: 123.5083,
      famousDishes: [
        {
          name: "Presko nga Gatas sa Kabaw ug Pastillas",
          emoji: "🥛",
          desc: "Creamy fresh water-buffalo milk and handcrafted sweet milk candies.",
        },
        {
          name: "Kinalan nga Manok Bisaya sa Barili",
          emoji: "🍲",
          desc: "Slow-simmered native farm chicken with fresh yellow squash and sitaw.",
        },
      ],
    },
  };
  ...
  const getDynamicPalengkePlan = (location, totalUserCalories = 2000) => {
    ...
    const sanitizeMealForUserAllergies = (mealTitle, mealType) => {
      ...
      const hasSeafoodAllergy = allergiesLower.some(
        (a) =>
          a.includes("seafood") ||
          a.includes("fish") ||
      ...
      if (hasSeafoodAllergy && isSeafoodMeal) {
        if (mealType === "Breakfast")
          safeTitle = "Sautéed Native Tomatoes & Malunggay with Steamed Kamote";
        else if (mealType === "Lunch")
          safeTitle =
            "Grilled Native Chicken Breast with Highland Sayote & Rice";
        else if (mealType === "Snack")
          safeTitle = "Steamed Sweet Corn & Cold Buko Water";
        else safeTitle = "Native Chicken Tinola with Squash & Kangkong Soup";
      }

      // 2. Egg Allergy Filter
      const isEggMeal = ["egg", "scramble", "omelette", "poached"].some((kw) =>
        lower.includes(kw),
      );
      if (hasEggAllergy && isEggMeal) {
        if (mealType === "Breakfast")
          safeTitle =
            "Steamed Kamote Slices & Calamansi Tea with Native Greens";
        else
          safeTitle = safeTitle.replace(
            /egg[s]?|omelette|scramble|poached/gi,
            "Native Greens",
          );
      }
      ...
      if (hasPorkAllergy && isPorkMeal) {
        safeTitle = safeTitle.replace(
          /pork|humba|liempo|chicharon|tuslob buwa|chiu-chiu/gi,
    ...
    return [
      {
        id: `palengke-${location.toLowerCase().replace(/\s+/g, "")}-breakfast`,
        mealType: "Breakfast",
        time: "7:30 AM",
        title: bTitle,
        calories: bKcal,
        ...
        carbsNum: bCarb,
        fatsNum: bFat,
        protein: `${bProt} protein`,
        carbs: `${bCarb}g`,
        fats: `${bFat}g`,
      },
      {
        id: `palengke-${location.toLowerCase().replace(/\s+/g, "")}-lunch`,
        mealType: "Lunch",
        time: "12:30 PM",
        title: lTitle,
        calories: lKcal,
        ...
        carbsNum: lCarb,
        fatsNum: lFat,
        protein: `${lProt} protein`,
        carbs: `${lCarb}g`,
        fats: `${lFat}g`,
      },
      {
        id: `palengke-${location.toLowerCase().replace(/\s+/g, "")}-snack`,
        mealType: "Snack",
        time: "4:00 PM",
        title: sTitle,
        calories: sKcal,
        ...
        carbsNum: sCarb,
        fatsNum: sFat,
        protein: `${sProt} protein`,
        carbs: `${sCarb}g`,
        fats: `${sFat}g`,
      },
      {
        id: `palengke-${location.toLowerCase().replace(/\s+/g, "")}-dinner`,
        mealType: "Dinner",
        time: "7:00 PM",
        title: dTitle,
        calories: dKcal,
  ...
  if (
    ...
    targetProtein = Math.round((calculatedTargetCalories * 0.3) / 4);
  ...
  const [dailyPlan, setDailyPlan] = useState(() => {
    if (Array.isArray(sessionRecipes) && sessionRecipes.length > 0) {
      return sessionRecipes;
    }
    return getDynamicPalengkePlan(
      selectedLocation || "Cebu City",
      targetCalories || 2000,
    );
  });
  ...
  useEffect(() => {
    ...
    const loadCachedOrFetchMeals = async () => {
      ...
      try {
        // 1. Check local cache first for instant display on tab switch
        const cachedRaw = await AsyncStorage.getItem(CACHE_KEY);
        if (cachedRaw) {
          const parsed = JSON.parse(cachedRaw);
          if (Array.isArray(parsed.meals) && parsed.meals.length > 0) {
            const hasGenericTitle = parsed.meals.some((m) =>
              String(m.title || "").includes(
                "Allergen-Free Pinoy High-Protein",
              ),
            );
        ...
        // 2. Fetch fresh data in background silently (NO full-screen loading modal on tab switch, matching Workout screen)
        ...
        if (__DEV__)
          console.log("MEAL RECOMMENDATION SILENT FETCH ERROR:", err);
      } finally {
        if (isMounted) setIsCacheChecked(true);
      }
    };

    // Defer heavy fetch slightly until after tab animation completes
    const timer = setTimeout(() => {
  ...
  const handleGenerateRecipe = async () => {
    if (!searchQuery.trim()) {
      showAlert(
        ...
        "Please enter some ingredients in the search bar first.",
      );
      return;
    }
    ...
    try {
      ...
      if (response.ok) {
        ...
        showAlert(
          "Success",
          "AI generated a healthy recipe matching your preferences!",
        );
      } else {
        showAlert(
          "AI Recipe Error",
          "Failed to generate recipe. Please check your network connection.",
        );
      }
    } catch (error) {
      showAlert(
    ...
    const mealName =
      ...
      (isRecipe
        ? Array.isArray(recipes)
          ? recipes.find((r) => `recipe-${r.id}` === safeId)?.title
          : null
        : null) ||
      "Meal";
    ...
    if (!loggedMeals.includes(safeId)) {
      ...
      const executeMealLog = async () => {
        ...
        const newNutrition = dailyNutrition
          ? {
              consumedCalories:
                (dailyNutrition.consumedCalories || 0) + addedCal,
              protein: {
                ...(dailyNutrition.protein || {}),
                current: (dailyNutrition.protein?.current || 0) + addedProt,
              },
              carbs: {
                ...(dailyNutrition.carbs || {}),
                current: (dailyNutrition.carbs?.current || 0) + addedCarb,
              },
              fats: {
                ...(dailyNutrition.fats || {}),
                current: (dailyNutrition.fats?.current || 0) + addedFat,
              },
            }
          : null;
        ...
        if (!isOnline) {
          ...
          showAlert(
            "📴 Saved Offline",
            `${mealName} logged locally. It will sync when connection returns.`,
          );
          return;
        }
        ...
        setDailyNutrition((prev) => {
          const next = {
            ...
            consumedCalories: Math.max(
              0,
              prev.consumedCalories - macros.calories,
            ),
            protein: {
              ...prev.protein,
              current: Math.max(0, prev.protein.current - macros.protein),
            },
            carbs: {
              ...prev.carbs,
              current: Math.max(0, prev.carbs.current - macros.carbs),
            },
            fats: {
              ...prev.fats,
              current: Math.max(0, prev.fats.current - macros.fats),
            },
          };
          newNutrition = next;
          return next;
      ...
      if (!isOnline) {
        ...
        showAlert(
          "📴 Saved Offline",
          "Meal removed locally. Will sync when back online.",
        );
        return;
      }
  ...
  const filteredRecipes = uniqueRecipes.filter((recipe) => {
    const matchesLocation =
      !recipe.location || recipe.location === selectedLocation;
  ...
  return (
    <View style={styles.fullscreenOverlay}>
        ...
        <View style={styles.header}>
          <View style={styles.headerTextGroup}>
            ...
            <Text style={styles.subGreeting}>
              Personalized meal suggestions built for your goals
            </Text>
          </View>
        </View>
          ...
          <View style={styles.dailyPlanSection}>
            ...
            <View style={styles.dailyProgressCard}>
              <View style={styles.macroRowInline}>
                <View style={styles.macroMiniBox}>
                  <Text
                    style={[
                      ...
                      {
                        fontSize: 10,
                        color: isOverCalories ? "#EF4444" : "#F97316",
                      },
                    ]}
                    numberOfLines={1}
                    ellipsizeMode="tail"
                  >
                    {Math.round(parseFloat(consumedCalories) || 0)}/
                    {Math.round(parseFloat(targetCalories) || 0)}
                  </Text>
                ...
                <View style={styles.macroMiniBox}>
                  ...
                  >
                    {Math.round(
                      parseFloat(dailyNutrition?.protein?.current) || 0,
                    )}
                    /{Math.round(parseFloat(targetProtein) || 0)}g
                  </Text>
                  <Text style={styles.macroMiniLabel} numberOfLines={1}>
                    Protein
                  </Text>
                ...
                <View style={styles.macroMiniBox}>
                  ...
                  >
                    {Math.round(
                      parseFloat(dailyNutrition?.carbs?.current) || 0,
                    )}
                    /{Math.round(parseFloat(targetCarbs) || 0)}g
                  </Text>
                  <Text style={styles.macroMiniLabel} numberOfLines={1}>
                    Carbs
                  </Text>
                ...
                <View style={styles.macroMiniBox}>
                  <Text
                    ...
                    ellipsizeMode="tail"
                  >
                    {Math.round(parseFloat(dailyNutrition?.fats?.current) || 0)}
                    /{Math.round(parseFloat(targetFats) || 0)}g
                  </Text>
                  <Text style={styles.macroMiniLabel} numberOfLines={1}>
                    Fats
                  </Text>
            ...
            <View style={{ marginBottom: 12 }}>
              <Text style={styles.sectionLabelTitle}>
                Your Daily AI Meal Plan
              </Text>
            </View>
            {/* SMART DYNAMIC MACRO REBALANCER CALCULATOR */}
            {(() => {
              const totalTargetCal = parseFloat(targetCalories) || 2000;
              const totalTargetProt = parseFloat(targetProtein) || 150;
              const totalTargetCarb = parseFloat(targetCarbs) || 225;
              const totalTargetFat = parseFloat(targetFats) || 55;

              const currentConsumedCal = parseFloat(
                dailyNutrition?.consumedCalories || 0,
              );
              const currentConsumedProt = parseFloat(
                dailyNutrition?.protein?.current || 0,
              );
              const currentConsumedCarb = parseFloat(
                dailyNutrition?.carbs?.current || 0,
              );
              const currentConsumedFat = parseFloat(
                dailyNutrition?.fats?.current || 0,
              );

              const remCal = Math.max(100, totalTargetCal - currentConsumedCal);
              const remProt = Math.max(
                10,
                totalTargetProt - currentConsumedProt,
              );
              const remCarb = Math.max(
                10,
                totalTargetCarb - currentConsumedCarb,
              );
              const remFat = Math.max(5, totalTargetFat - currentConsumedFat);
              ...
              const planList = Array.isArray(dailyPlan) ? dailyPlan : [];
              let unloggedWeightSum = 0;
              planList.forEach((meal, idx) => {
                const mealCat = meal?.mealType || meal?.time || "";
                const mealId = String(meal?.id || `meal-plan-${idx}`);
                const isLogged = loggedMeals.some((m) => {
                  if (typeof m === "object" && m !== null) {
                    return (
                      String(m.id) === mealId ||
                      String(m.mealType || m.category).toLowerCase() ===
                        String(mealCat).toLowerCase()
                    );
                  }
                  return String(m) === mealId;
                });
                if (!isLogged) {
                  unloggedWeightSum += DEFAULT_SLOT_WEIGHTS[mealCat] || 0.25;
                }
              });
              if (unloggedWeightSum <= 0) unloggedWeightSum = 1;

              const hasAnyLoggedMeal = loggedMeals && loggedMeals.length > 0;
                ...
                <View style={styles.timelineContainer}>
                  {hasAnyLoggedMeal && (
                    ...
                    >
                      ...
                      >
                        Smart Rebalancing Active: Remaining AI meals
                        automatically adjusted to keep you on track for your{" "}
                        {Math.round(totalTargetCal)} kcal goal!
                      </Text>
                    </View>
                  )}
                  ...
                  {(!isCacheChecked || (isGeneratingMealPlan && planList.length === 0)) ? (
                    ...
                    >
                      ...
                      >
                        Tap below to generate custom meal recommendations
                        calculated for your exact daily macros.
                      </Text>
                      <TouchableOpacity
                        style={{
                        ...
                        onPress={async () => {
                          try {
                            ...
                            const res = await fetch(
                              `${API_URL}/meals/recommend/${userId || "default"}`,
                            );
                            if (res.ok) {
                              const data = await res.json();
                              if (Array.isArray(data) && data.length > 0) {
                            ...
                            showAlert(
                              "Error",
                              "Could not fetch AI recommendations. Please check connection.",
                            );
                          } finally {
                    ...
                    planList.map((meal, index) => {
                      ...
                      const slotLoggedMeal = loggedMeals.find((m) => {
                        if (typeof m === "object" && m !== null) {
                          return (
                            String(m.id) === mealId ||
                            String(m.mealType || m.category).toLowerCase() ===
                      ...
                      const isLogged = Boolean(slotLoggedMeal);

                      let catName = translateMealCategory(
                        meal?.mealType || "Meal",
                        language,
                      );
                      let displayTitle = meal?.title || "Healthy Meal";
                      let displayCalories = meal?.calories || 0;
                      let displayProtein =
                        meal?.proteinNum || parseInt(meal?.protein) || 0;
                      let displayCarbs =
                        meal?.carbsNum || parseInt(meal?.carbs) || 0;
                      let displayFats =
                        meal?.fatsNum || parseInt(meal?.fats) || 0;
                      let badgeLabel = catName;

                      if (isLogged) {
                        if (
                          typeof slotLoggedMeal === "object" &&
                          slotLoggedMeal !== null
                        ) {
                          displayTitle =
                            slotLoggedMeal.name ||
                            slotLoggedMeal.title ||
                            meal?.title;
                          displayCalories =
                            slotLoggedMeal.calories || meal?.calories || 0;
                          displayProtein = slotLoggedMeal.protein || 0;
                          displayCarbs = slotLoggedMeal.carbs || 0;
                          displayFats = slotLoggedMeal.fats || 0;
                          badgeLabel = `${catName} • Logged 📸`;
                        } else {
                          badgeLabel = `${catName} • Logged 🍽️`;
                        }
                      } else {
                        // Dynamically rebalanced values for remaining unlogged meals!
                        const weight =
                          (DEFAULT_SLOT_WEIGHTS[mealCat] || 0.25) /
                          unloggedWeightSum;
                        displayCalories = Math.round(remCal * weight);
                        displayProtein = Math.round(remProt * weight);
                        displayCarbs = Math.round(remCarb * weight);
                        displayFats = Math.round(remFat * weight);
                      }
                            ...
                            <View style={styles.timelineFooter}>
                              <View style={{ flex: 1, paddingRight: 8 }}>
                                <Text style={styles.timelineMacroText}>
                                  {displayCalories} kcal • {displayProtein}g
                                  protein
                                </Text>
                                <TouchableOpacity
                ...
                <View style={{ marginTop: 12 }}>
                  ...
                  >
                    ...
                    >
                      ...
                      <Text style={styles.cityDetailTitle} numberOfLines={1}>
                        {CITY_PROFILES[selectedLocation].marketTitle ||
                          `${selectedLocation} Food Market`}
                      </Text>
                    </View>
                  </View>
                  ...
                  >
                    ...
                    <Text style={[styles.cityPalengkeText, { flex: 1 }]}>
                      <Text style={{ fontWeight: "700" }}>Local Supplies:</Text>{" "}
                      {CITY_PROFILES[selectedLocation].palengkeItems}
                    </Text>
                  </View>
                </View>
              )}
            ...
            {CITY_PROFILES[selectedLocation] && (
              <>
                <View style={{ marginBottom: 16 }}>
                  {(() => {
                    const todayPlan = getDynamicPalengkePlan(
                      selectedLocation,
                      targetCalories,
                      targetProtein,
                      targetCarbs,
                    ...
                    const totalKcal = todayPlan.reduce(
                      (acc, m) => acc + m.kcal,
                      0,
                    );
                    const allergiesText =
                    ...
                    return (
                      <>
                        ...
                        >
                          ...
                          >
                            🍽️ 1-Day Local Diet ({selectedLocation})
                          </Text>
                          <View
                            style={{
                              backgroundColor: isDarkMode
                        ...
                        >
                          ...
                          >
                            🛡️ Allergy Safety Active: Filtered for your profile
                            ({allergiesText})
                          </Text>
                        </View>
                        ...
                        <View style={styles.timelineList}>
                          {todayPlan.map((mealItem, idx) => {
                            ...
                            const translatedCat = translateMealCategory(
                              rawCat,
                              language,
                            );
                                ...
                                >
                                  ...
                                  <View style={styles.timelineFooter}>
                                    <View style={{ flex: 1, paddingRight: 8 }}>
                                      <Text style={styles.timelineMacroText}>
                                        {mealItem.kcal} kcal •{" "}
                                        {mealItem.proteinNum} protein
                                      </Text>
                                      <TouchableOpacity
                                        style={styles.viewRecipeTextBtn}
                                        onPress={() =>
                                          handleViewRecipe(mealItem)
                                        }
                                        activeOpacity={0.6}
                                      >
                                        <ChefHat
                                          color={
                                            isLogged ? "#64748B" : accentColor
                                          }
                                          size={14}
                                          style={{ marginRight: 4 }}
                                        />
                                    ...
                                    >
                                      {isLogged ? (
                                        <>
                                          ...
                                          <Text
                                            style={
                                              styles.logMealMiniBtnTextLogged
                                            }
                                          >
                                            Logged
                                          </Text>
                                        ...
                                        <>
                                          ...
                                          />
                                          <Text
                                            style={styles.logMealMiniBtnText}
                                          >
                                            Log Meal
                                          </Text>
                                        </>
                ...
                {CITY_PROFILES[selectedLocation].famousDishes && (
                  <View style={[styles.formCard, { marginBottom: 24 }]}>
                    ...
                    >
                      ...
                      />
                      <Text style={styles.cardTitle}>
                        Famous Delicacies ({selectedLocation})
                      </Text>
                    </View>
                    <Text
                      style={{
                    ...
                    >
                      Iconic local dishes, traditional street food, and heritage
                      delicacies famous in {selectedLocation}:
                    </Text>

                    <View style={{ gap: 10 }}>
                      {CITY_PROFILES[selectedLocation].famousDishes.map(
                        (dish, idx) => (
                          <View
                            key={idx}
                            style={{
          ...
          {selectedRecipe && (
            <>
              <Text style={styles.recipeModalTitle}>
                {translateMealTitle(selectedRecipe.title, language)}
              </Text>
              ...
              <View style={styles.recipeModalMetaRow}>
                ...
                <View style={[styles.recipeModalMetaBadge, { marginLeft: 8 }]}>
                  ...
                  <Text style={styles.recipeModalMetaText}>
                    {selectedRecipe.budget || "Under ₱100"}
                  </Text>
                </View>
              </View>
              ...
              <View style={styles.recipeModalMacrosGrid}>
                <View style={styles.recipeModalMacroBox}>
                  <Text
                    style={[styles.recipeModalMacroVal, { color: "#F97316" }]}
                  >
                ...
                >
                  <Text
                    style={[styles.recipeModalMacroVal, { color: "#10B981" }]}
                  >
                ...
                >
                  <Text
                    style={[styles.recipeModalMacroVal, { color: "#F59E0B" }]}
                  >
                ...
                >
                  <Text
                    style={[styles.recipeModalMacroVal, { color: "#EC4899" }]}
                  >
                    {selectedRecipe.fats}
                  </Text>
              ...
              >
                <View style={styles.recipeModalIngredientsBox}>
                  ...
                  {(selectedRecipe.ingredients || []).map((ing, i) => (
                    <Text key={i} style={styles.recipeModalListItem}>
                      • {ing}
                    </Text>
                  ))}
                </View>
              ...
              {/* Close Button */}
              <TouchableOpacity
                style={styles.recipeModalCloseBtn}
                onPress={() => setShowRecipeModal(false)}
              >
                <Text style={styles.recipeModalCloseBtnText}>
                  Dismiss Recipe
                </Text>
              </TouchableOpacity>
            </>
      ...
      <AILoadingModal
        visible={isFetchingRecipe || isGeneratingMealPlan}
        type={isFetchingRecipe ? "recipe" : "meal"}
        title={
          isFetchingRecipe
            ? "Crafting Custom Recipe"
            : "Generating AI Daily Meal Plan"
        }
        subtitle={
          isFetchingRecipe
            ? "Vita AI is personalizing your nutrition"
            : "Vita AI is calculating your optimal daily macros"
        }
      />
    </View>
  );
